var Main = function() {
  var Path = require('path'),
    Debug = require('debug')('parallel-cucumber-js'),
    FeaturesRunner = require('../../cucumber/runtime/features_runner.js'),
    EventBroadcaster = require('../../cucumber/runtime/event_broadcaster.js'),
    self = {};
  ...
  self._init = function(options) {
    ...
    self.Cucumber.Runtime.EventBroadcaster = function(listeners, supportCodeLibrary) {
      var eventBroadCasterInstance = EventBroadcaster(listeners, supportCodeLibrary);
      self.eventBroadcaster = eventBroadCasterInstance;
      return eventBroadCasterInstance;
    };

    self.Cucumber.Runtime.FeaturesRunner = FeaturesRunner;
