// flag to prevent firing BeforeFeatures more than once
var fireBeforeFeatures = true,
// saves AfterFeatures event to fire once after all features
...
function EventBroadcaster(listeners, supportCodeLibrary) {
  ...
  // customised broadcaster in order to fire BeforeFeatures and AfterFeatures once
